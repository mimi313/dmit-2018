<%@ Page Title="Multi View Setup" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MultiViewSetup.aspx.cs" Inherits="WebApp.SamplePages.MultiViewSetup" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

    <h1>Multi View Setup</h1>
    <div class="row">
        <div class="offset-1">
            <asp:Menu ID="Menu1" runat="server"
                ...
                <Items>
                    <asp:MenuItem Text="Page1" Selected="true" Value="0"></asp:MenuItem>
