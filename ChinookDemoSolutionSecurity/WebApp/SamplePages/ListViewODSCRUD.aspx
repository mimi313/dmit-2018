...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        <div class="offset-1">
            ...
            <asp:ValidationSummary ID="ValidationSummaryEdit" runat="server" HeaderText="Following are concerns with yoru data:"
                 ValidationGroup="egroup"/>
            <asp:ValidationSummary ID="ValidationSummaryInsert" runat="server" HeaderText="Following are concerns with yoru data:"
        ...
        <asp:ListView ID="AlbumList" runat="server" DataSourceID="AlbumListODS" InsertItemPosition="FirstItem"
            ...
            <EditItemTemplate>
                ...
                <asp:RequiredFieldValidator ID="RequiredTitleE" runat="server" 
                    ErrorMessage="Album title is required on edit."
                ...
                <asp:RequiredFieldValidator ID="RequiredReleaseYearE" runat="server" 
                    ErrorMessage="Release year is required on edit."
                    ControlToValidate="ReleaseYearTextBoxE" Display="None" 
                    ValidationGroup="egroup"></asp:RequiredFieldValidator>

                <asp:RegularExpressionValidator ID="RegExTitleE" runat="server" 
                    ErrorMessage="Album title is limited to 160 characters." ControlToValidate="TitleTextBoxE" Display="None"
                ...
                <asp:RegularExpressionValidator ID="RegExReleaseLabelE" runat="server" 
                    ErrorMessage="Release label is limited to 50 characters." ControlToValidate="ReleaseLabelTextBoxE" Display="None"
                ...
                <asp:CompareValidator ID="CompareReleaseYearE" runat="server" ErrorMessage="Year must be a number."
                     ControlToValidate="ReleaseYearTextBoxE" Display="None"
                     Operator="DataTypeCheck" Type="Integer" ValidationGroup="egroup"></asp:CompareValidator>

                <asp:RangeValidator ID="RangeReleaseYearE" runat="server" ErrorMessage="Year must be between 1950 and this year."
                     ControlToValidate="ReleaseYearTextBoxE" Display="None" ValidationGroup="egroup"
                ...
                <tr style="background-color: #999999;">
                    ...
                    <td>
                        ...
                        <asp:DropDownList ID="ArtistList" runat="server" 
                            ...
                            Width="300px"><%--Here it's Bind, not Eval--%>
                        </asp:DropDownList>
                    <td>
                        <asp:TextBox Text='<%# Bind("ReleaseYear") %>' runat="server" ID="ReleaseYearTextBoxE" Width="70px"/></td>
                    <td>
                        <asp:TextBox Text='<%# Bind("ReleaseLabelE") %>' runat="server" ID="ReleaseLabelTextBox" /></td>
                </tr>
            </EditItemTemplate>
            <EmptyDataTemplate>
            ...
            <InsertItemTemplate>
                <asp:RequiredFieldValidator ID="RequiredTitleI" runat="server" 
                    ErrorMessage="Album title is required on insert."
                ...
                <asp:RequiredFieldValidator ID="RequiredReleaseYearI" runat="server" 
                    ErrorMessage="Release year is required on insert."
                    ControlToValidate="ReleaseYearTextBoxI" Display="None" 
                    ValidationGroup="igroup"></asp:RequiredFieldValidator>

                <asp:RegularExpressionValidator ID="RegExTitleI" runat="server" 
                    ErrorMessage="Album title is limited to 160 characters." ControlToValidate="TitleTextBoxI" Display="None"
                     ValidationGroup="igroup" ValidationExpression="^.{1,160}$"></asp:RegularExpressionValidator>

                <asp:RegularExpressionValidator ID="RegExReleaseLabelI" runat="server" 
                    ErrorMessage="Release label is limited to 50 characters." ControlToValidate="ReleaseLabelTextBoxI" Display="None"
                ...
                <asp:CompareValidator ID="CompareReleaseYearI" runat="server" ErrorMessage="Year must be a number."
                     ControlToValidate="ReleaseYearTextBoxI" Display="None"
                     Operator="DataTypeCheck" Type="Integer" ValidationGroup="igroup"></asp:CompareValidator>

                <asp:RangeValidator ID="RangeReleaseYearI" runat="server" ErrorMessage="Year must be between 1950 and this year."
                     ControlToValidate="ReleaseYearTextBoxI" Display="None" ValidationGroup="igroup"
                     MinimumValue="1950" MaximumValue="<%# DateTime.Today.Year %>"></asp:RangeValidator>
                <tr style="">
                    <td>
