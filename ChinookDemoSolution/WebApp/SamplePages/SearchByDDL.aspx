...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        <div class="offset-3">
            ...
            <asp:DropDownList ID="ArtistList" runat="server" Width="400px"></asp:DropDownList>&nbsp;&nbsp;
            ...
            <asp:GridView ID="ArtistAlbumList" runat="server" 
                ...
                <Columns>
                    <asp:TemplateField HeaderText="Album">
                        <ItemTemplate>
                            <asp:Label ID="Label2" runat="server" Text='<%# Eval("Title") %>'></asp:Label> <%--Comes from ArtistAlbums ViewModel--%>
                        </ItemTemplate>
                    </asp:TemplateField>
